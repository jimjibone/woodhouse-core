...
import { DevicesStreamRequest, DeviceService, FavoritesStreamRequest } from '$lib/api/v1/clients/user_service_pb';
...
const streamFavorites = async (client: PromiseClient<typeof UserService>, abortSignal: AbortSignal, heartbeat: HeartbeatHandler) => {
	let didConnect = false;
	const request = new FavoritesStreamRequest({});
	try {
