...
type ColorValue struct {
	...
	Hue float32 `protobuf:"fixed32,1,opt,name=hue,proto3" json:"hue,omitempty"` // Hue value: 0-360 degrees
	Sat float32 `protobuf:"fixed32,2,opt,name=sat,proto3" json:"sat,omitempty"` // Saturation value: 0-100 percent
}
...
func (x *ColorValue) GetHue() float32 {
	if x != nil {
		return x.Hue
	}
	return 0
...
func (x *ColorValue) GetSat() float32 {
	if x != nil {
		return x.Sat
	}
	return 0
...
var file_value_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x77,
	0x6f, 0x6f, 0x64, 0x68, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x22, 0x21, 0x0a, 0x09,
	...
	,
...
var file_value_proto_goTypes = []interface{}{
	(*BoolValue)(nil),   // 0: woodhouse.api.BoolValue
	(*NumberValue)(nil), // 1: woodhouse.api.NumberValue
	(*TextValue)(nil),   // 2: woodhouse.api.TextValue
	(*ColorValue)(nil),  // 3: woodhouse.api.ColorValue
}
